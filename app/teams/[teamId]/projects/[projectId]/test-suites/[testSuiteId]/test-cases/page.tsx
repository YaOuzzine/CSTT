...
export default function TestCases({ params }: { params: { teamId: string; projectId: string; testSuiteId: string } }) {
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span
                        className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${getPriorityClass(testCase.priority)}`}
                      >
                        {testCase.priority}
                      </span>
                    </div>
